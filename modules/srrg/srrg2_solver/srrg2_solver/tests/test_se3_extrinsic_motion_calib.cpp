...
const std::string exe_name = "test_se3_extrinsic_motion_calib_ad";
...
TEST(DUMMY_DATA, SE3SensorExtrinsicPoseMotionCalibAD) {
  // ldg types for this test
  using VType = VariableSE3QuaternionRightAD;
  using FType = SE3SensorExtrinsicPoseMotionCalibAD;
