...
namespace srrg2_solver {
  ...
  template <typename GraphItemPtrType_>
  struct GraphItemPtrIdCompare_{
    inline bool operator()(const GraphItemPtrType_& a,
                           const GraphItemPtrType_& b) const {
  ...
  public:
    ...
    using ClosureStatsMap    = std::map<FactorBase*, ClosureStats, GraphItemPtrIdCompare_<FactorBase*> >;
    using ClosureStatsPtrMap = std::map<FactorBasePtr, ClosureStats*, GraphItemPtrIdCompare_<FactorBasePtr>>;
  ...
  protected:
    ...
    std::map<FactorBase*, FactorBasePtr, GraphItemPtrIdCompare_<FactorBase*> > _ptr_sptr_map;
    std::set<VariableBase*, GraphItemPtrIdCompare_<VariableBase*> > _constants;
    ...
    std::map<VariableBase*, FactorGraphView*, GraphItemPtrIdCompare_<VariableBase*> > var_to_partition_map;
    std::set<VariableBase*, GraphItemPtrIdCompare_<VariableBase*> > open_variables;
