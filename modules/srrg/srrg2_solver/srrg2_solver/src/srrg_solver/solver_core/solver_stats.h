...
namespace srrg2_solver {
  ...
  struct FactorStats {
    enum Status { Error = 0x0, Inlier = 0x1, Kernelized = 0x2, Suppressed = 0x3 };
    Status status              = Error;
  ...
  struct IterationStats {
    ...
    float chi_kernelized       = 0.f; /*!< inliers+kernelized squared error */
    int dim_variables          = 0;
    int dim_factors            = 0;
    int num_inliers            = 0;
    int num_outliers           = 0;
    ...
    float constraint_violation_norm = 0;
