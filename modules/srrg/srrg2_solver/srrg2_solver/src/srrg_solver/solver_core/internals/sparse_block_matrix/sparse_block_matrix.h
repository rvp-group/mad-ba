...
namespace srrg2_solver {
  ...
  public:
    ...
    */
    ...
    /*! prints stuff */
    void printLayout(PrintMode mode = PrintMode::PrintValues, std::ostream& os=std::cout) const;
    ...
    */
    ...
    /*! @return Dense vector representing the entries of the matrix */
    void fromDenseVector(const std::vector<float>& v);
    ...
    */
    ...
    void fillEigenSparse(Eigen::SparseMatrix<double>& target, bool is_symmetric_=true) const;
