...
namespace srrg2_solver {
  ...
  class
   ...
   __align__(16)
  #endif 
  FactorBase : public Identifiable,
                     public DrawableBase,
  ...
  public:
    ...
    */
    ...
    virtual bool variablesUpdated() const = 0;

    /*! appends to dest the ids of the variables that will be updated */
    virtual void updateVariablesAccessPattern(std::vector<VariableBase::Id>& dest) const = 0;
  ...
  protected:
    ...
    */
    virtual void bind(IdVariablePtrContainer& container) = 0;
    ...
    */
    ...
    // finalizes the computation if stable sum is used in nested factors
    virtual void finalizeCompute(bool chi_only=false) {}
    // finalizes the computation if stable sum is used in nested factors
    virtual void resetCompute(bool chi_only=false) {}
