  ...
  */
  ...
  public:
    ...
    */
    ...
    bool variablesUpdated() const override {
      return _variables.updated();
    }

    void updateVariablesAccessPattern(std::vector<VariableBase::Id>& dest) const override;
  ...
  protected:
    ...
    */
    ...
    void bind(IdVariablePtrContainer& container) override;
