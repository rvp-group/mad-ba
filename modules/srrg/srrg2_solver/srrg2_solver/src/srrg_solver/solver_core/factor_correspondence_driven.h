...
namespace srrg2_solver {
  ...
  public:
    ...
    */
    ...
    void storeCorrespondences(const CorrespondenceContainerType& correspondences_) {
      _stored_correspondences = correspondences_;
      _correspondences = &_stored_correspondences;
      setBegin();
    }
  ...
  protected:
    ...
    const CorrespondenceContainerType* _correspondences = nullptr;       /*!< Correspondences
                                                                           container pointer */
    CorrespondenceContainerType _stored_correspondences;
