...
int main(int argc, char** argv) {
  ...
  graph->write("/home/barbara/source/srrg2/srrg2_splam/config/se2_icp_factor_graph.json");
  ...
  solver.compute();
  auto result_info = solver.extractFisherInformationBlock(*pose);
  LOG << "information matrix: " << endl;
  LOG << result_info << endl;
