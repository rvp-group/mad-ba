...
void initGraphGenerators() {
  ...
  graph_generators.insert(make_pair("se3_ba", GraphGeneratorPtr(new GraphGeneratorSE3OmniBA(sim))));
  graph_generators.insert(make_pair("se3_pr", GraphGeneratorPtr(new GraphGeneratorSE3PinholeBA(sim))));
  graph_generators.insert(make_pair("se3_stereo", GraphGeneratorPtr(new GraphGeneratorSE3RectifiedStereo(sim))));
