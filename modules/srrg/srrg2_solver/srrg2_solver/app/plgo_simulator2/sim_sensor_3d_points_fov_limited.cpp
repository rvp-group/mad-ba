...
namespace srrg2_solver {
  ...
  bool SimSensor3DPointsFOVLimited::computeMeasurementInSensor(Eigen::Vector3f& measurement,
                                                               const Eigen::Vector3f& world_point) {
    return computePointInSensor(measurement, world_point);
  }

  void SimSensor3DPointsFOVLimited::computeEpoch(FactorGraph& graph, VariableBase::Id current_pose_id) {
