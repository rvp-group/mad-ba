...
if __name__ == "__main__":
    ...
    # Names of GT maps
    gt_maps_names = ['mesh.ply', 'new-college-29-01-2020-1cm-resolution-1stSection - mesh.ply',  'new-college-29-01-2020-1cm-resolution-1stSection.ply', 'new-college-29-01-2020-5cm-resolution.ply']
    # Names of user maps
    user_maps_names = ['surfelCloud_0.pcd', 'surfelCloud_3.pcd']
